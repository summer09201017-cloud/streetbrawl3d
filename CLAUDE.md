# CLAUDE.md — streetbrawl3d(2.5D 街頭快打,fork warrior3d)(3D 武士勇者比武=jousting3d 的無馬徒步版,德義武鬥館)

> ★2.5D 化(07-17 使用者拍板):鎖 z=0+恆自動面向對手——玩家不控方向,專心「進退距離+
> 換武器+出招/格擋/技能」。側視鏡頭跟兩人中點依距離變焦(快打旋風式);同機雙人的最佳載體
> (duel-2p-kit 未來接這裡)。改動三處:updatePlayerMovement(←→=進退)、movePos+主迴圈
> (鎖線+恆面向,跳殺空中例外)、updateCamera(側視主鏡頭+俯瞰兩檔)。其餘引擎與 warrior3d 同源。
